...
<<<<<<< HEAD
    ...
    # Pronoms possessifs qui renvoient à un antécédent
    r"son|sa|ses|"
    # Démonstratifs qui renvoient à un antécédent
    r"ce service|ce poste|ce responsable|cet? (employ[eé]|agent|chef)|"
    r"m[eê]me (d[eé]partement|service|direction|poste)|"
    # Questions de suivi commençant par "et" ou "aussi"
